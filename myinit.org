...
* try
  ...
  #+END_SRC
* which-key
   ;; if you don't finish a command, it will list all left.
  #+BEGIN_SRC emacs-lisp
...
* ivy
  通过在迷你缓冲区中预览时缩小可用选项来完成选择过程
   ...
   #+END_SRC
* counsel and swiper
  ;; much better search and tips messages
  ;; 关于使用增量搜索来浏览emacs缓冲区的全部内容
  #+BEGIN_SRC emacs-lisp
  (use-package counsel
    :ensure t)
  (use-package swiper
